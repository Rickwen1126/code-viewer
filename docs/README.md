...
- `git-tour-origin-context/`: the active-topic folder for preserving return context when navigating from Git diff or CodeTour into Code Viewer and then back to the original context.
