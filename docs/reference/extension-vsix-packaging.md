...
code --install-extension /Users/rickwen/code/code-viewer/extension/code-viewer-extension-0.0.3.vsix --force
```
...
```bash
unzip -l extension/code-viewer-extension-0.0.3.vsix
```
...
- Do not trust a stale `code-viewer-extension-0.0.3.vsix` file. Re-run `pnpm --dir extension package`.
